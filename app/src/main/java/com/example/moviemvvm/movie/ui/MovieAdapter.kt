...
import com.example.moviemvvm.databinding.ListItemMovieBinding
...
class MovieAdapter : PagedListAdapter<Movie, MovieAdapter.ViewHolder>(MovieDiffCallback()) {
    ...
    class ViewHolder(private val binding:ListItemMovieBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ListItemMovieBinding.inflate(
